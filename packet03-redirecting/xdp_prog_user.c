...
/**
 * Validates if a string is in MAC address format.
 *
 * @mac: The MAC address string to validate (XX:XX:XX:XX:XX:XX format).
 *
...
{
	// Length of a mac address should be 17
	if (strlen(mac) != MAC_ADDRESS_SIZE)
	{
		return 0;
	}
